...
#define  TASKA_TASK_PRIORITY  2
#define  TASKB_TASK_PRIORITY  1

#define  TIME_OUT				(TickType_t) 0
#define  INIT_TASK_STACK_SIZE	100
#define  TASKA_TASK_STACK_SIZE  400
#define  TASKB_TASK_STACK_SIZE  400

/************************************************************************/
/*						Extern Global variables  				        */
/************************************************************************/
extern TaskHandle_t Init_Task_Handle;
extern TaskHandle_t TaskA_Handle;
extern TaskHandle_t TaskB_Handle;
